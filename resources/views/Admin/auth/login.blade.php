...
<head>
    ...
    <meta name="keywords"
          content="{{asset('assets/admin')}} template, modern admin template, dashboard template, flat admin template, responsive admin template, web app, crypto dashboard, bitcoin dashboard">
                                    ...
                                    <form class="form-horizontal form-simple" action="{{route('login')}}" method="post"
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input type="text" name="phoneNumber"
                                                   ...
                                                   value="" id="phone" placeholder="أدخل رقم الهاتف ">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-6 col-12 text-center text-md-left">
                                             ...
                                             <div class="form-group row">
                                           <a href="">  <div class="col-md-12 col-12  text-md-right">ليس لدى حساب</div></a>
                                           </div>
